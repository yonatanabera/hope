                ...
                <div className="" id="home">
                    ...
                    <div className="relative  h-screen w-full bg-center bg-[url(https://websitedemos.net/agency-02/wp-content/uploads/sites/30/2020/06/home-hero-bg.jpg)] bg-cover ">
                        ...
                        <div className="flex flex-col gap-10 justify-center h-screen ">
                            <div className="flex items-center lg:items-center justify-center lg:justify-start">
                                <div className="lg:basis-1/2 md:basis-2/3 sm:basis-2/3 flex flex-col gap-5 relative text-white px-5 lg:px-20 lg:text-left text-left">
                                    <div className="font-bold capitalize text-lg">
                                        Lorem ipsum dolor sit amet consectetur.
                                    </div>
                                    <div className="text-3xl lg:text-6xl md:text-5xl font-extrabold capitalize">
...
function PartnersLogo({}) {
    return (
        <>
            <div className="flex flex-col gap-5 bg-transparent lg:basis-1/5 lg:p-10 rounded-lg">
                <div>
                    <svg
